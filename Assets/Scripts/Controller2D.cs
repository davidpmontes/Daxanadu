...
public class Controller2D : RaycastController
{
    ...
    [HideInInspector] Vector2 playerInput;
    ...
    public void Move(Vector2 moveAmount, Vector2 input, bool standingOnPlatform = false)
    {
        ...
        /*
         * Important that this is after the previous if statement
         * to ensure sliding down maxsteep slopes is smooth
         */
        if (moveAmount.x != 0)
        {
        ...
        for (int i = 0; i < verticalRayCount; i++)
        {
            ...
            if (hit)
            {
                if (hit.collider.tag == "Through")
                {
                     ...
                     * hit.distance == 0 -> prevents player from slide up to top of platform
                     */
                    ...
                    /*
                     * Falling down through platforms
                     */
                    if (playerInput.y == -1)
                    {
